package com.example.utils.widget.nicespinner;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private int dropBackgroundSelector;
...
//                defaultPadding);
        ...
        dropBackgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_dropBackground, R.drawable.selector);
...
//        }
        popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, dropBackgroundSelector));
...
//    public void setDropdownBg(int resId) {
//        if(popupWindow != null)
//            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(getContext(),resId));
//    }
    ...
    public <T> void attachDataSource(List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, dropBackgroundSelector,
                spinnerTextFormatter);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapterWrapper(getContext(), adapter, textColor, dropBackgroundSelector,
                spinnerTextFormatter);
