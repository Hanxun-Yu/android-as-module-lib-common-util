...
//                        inetAddress.getAddress();
    ...
    public static String getSNByMac() {
        String ret = "";
        String mac = getActiveMac();
        String[] hexArr = mac.split(":");
...
//            Log.d("_xunxun","getSNByMac:"+ret);
            ret = ret.replaceFirst("0","");
        }

        ret = String.valueOf(Long.parseLong(ret,16));
        return ret;
    }
    ...
    public static String getAndroidOsSystemProperties(String key) {
        String ret;
        try {
            Method systemProperties_get = systemProperties_get = Class.forName("android.os.SystemProperties").getMethod("get", String.class);
